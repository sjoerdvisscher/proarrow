...
import Proarrow.Core (CategoryOf (..), PRO, Profunctor (..), Promonad (..), lmap, obj, (//))
import Proarrow.Functor (Functor (..), Prelude (..))
import Proarrow.Object.BinaryCoproduct (COPROD (..), Coprod (..), HasBinaryCoproducts (..), HasCoproducts, lft, rgt)
