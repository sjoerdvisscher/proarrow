...
class (HasCompanions hk vk, Ob j) => HasColimits vk (j :: hk a i) k where
  ...
  colimit :: (Ob (d :: vk i k)) => Companion hk vk d `O` j ~> Companion hk vk (Colimit j d)
  colimitUniv :: (Ob (d :: vk i k), Ob p) => Companion hk vk d `O` j ~> Companion hk vk p -> Colimit j d ~> p
